...
/**
 * Created by ALBERT on 2/17/2018.
 */
...
public class BuilderManager {
    ...
    static int getcolorResources() {
        if (imageResourceIndex >= colorResources.length) imageResourceIndex = 0;
        return colorResources[imageResourceIndex++];
    }

    static String getStringResources() {
        if (imageResourceIndex >= StringResources.length) imageResourceIndex = 0;
        return StringResources[imageResourceIndex++];
    }
    ...
    static TextInsideCircleButton.Builder getTextInsideCircleButtonBuilder() {
        return new TextInsideCircleButton.Builder()
                .normalImageRes(getImageResource())
                .normalColorRes(getcolorResources())
                .normalText(getStringResources());
